...
class Tile
{
    ...
    public:
        ...
        and isZombieVisible should be false; tile_icon = 'm'.*/
        Tile();
        //====================================================
        /*Assigns corresponding variables and if isZombie is true, 
        then it should increment num_zombies by 1. tile_icon = 'm'.*/
        ...
        //Assigns the icon_value only if the input is ‘x’, 'm', or ‘*’
